...
| `Background`   | Decorative wallpaper, `dots` polka-dot / `sprinkles` cylindrical candy-sprinkle patterns (zero image assets), children render above the pattern                                                        |             | ✓                         |
